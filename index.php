...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">INFO@Purple-Orchid.COM</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+234- 9099414441</li>	
					<li class="s-bar">
						<div class="search">
					...
					<li>
						<div class="w3layouts-banner-top w3layouts-banner-top1">
							<div class="container">
								<div class="agileits-banner-info">
								<h4>Purple Orchid</h4>
									<h3>We make the ordinary, extraordinary</h3>
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
						   ...
						   <p class="about-para-w3ls">Maximum luxury. Exclusive sensation</p>
						   <img src="images/hs1.jpg" class="img-responsive" alt="Pool side">
										<div class="w3l-slider-img">
											<img src="images/spa1.jpg" class="img-responsive" alt="SPA">
										</div>
                                       <div class="w3ls-info-about">
										    <h4>You'll love all the amenities we offer!</h4>
											<p>Tanning Butler,Gondola Couples Massage,In-room Arcade Games,etc. </p>
										</div>
		          </div>
		   	<div class="clearfix"> </div>
    </div>
...
<section class="portfolio-w3ls" id="gallery">
		 <h3 class="title-w3-agileits title-black-wthree">Our Gallery</h3>
				...
				<div class="col-md-3 gallery-grid gallery1">
					<a href="images/b8.jgp" class="swipebox"><img src="images/b8.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>Purple Orchid</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
	 ...
	 <!-- rooms & rates -->
      <div class="plans-section" id="rooms">
				...
				<div class="col-md-3 price-grid ">
					<div class="price-block agile">
						<div class="price-gd-top">
						<img src="images/i8.jpg" alt=" " class="img-responsive" />
							<h4>Luxury Room</h4>
						</div>
						<div class="price-gd-bottom">
							<div class="price-list">
					...
					<ul class="slides">
						...
						<li>
							<div class="w3layouts_work_grid_left">
								<img src="images/55.jpg" alt=" " class="img-responsive" />
								<div class="w3layouts_work_grid_left_pos">
									<img src="images/n6.png" alt=" " class="img-responsive" />
								</div>
							</div>
							<div class="w3layouts_work_grid_right">
								<h4>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+234-9099414441</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@PURPLEORCHID.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> American University of Nigeria 98 Lamido Zubairu Way Yola Township bypass PMB 2250, Yola Adamawa State, Nigeria</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2021 Purple Orchid . All Rights Reserved | Design by <a href="index.php">Purple Orchid</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
